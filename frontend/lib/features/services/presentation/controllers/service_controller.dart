...
import 'package:frontend/features/services/data/service_repository.dart';
...
class ServiceNotifier
  ...
  @override
  Future<PaginatedState<ServiceModel>> build() {
    ref.clearOnLogout();
    return super.build();
  }
...
final myServiceProvider = FutureProvider.family<ServiceModel?, (int, int)>((
  ...
  return ref.read(serviceRepositoryProvider).getMyServiceForSubcategory(
...
class EditableServiceNotifier extends Notifier<AsyncValue<ServiceDetailModel>> {
  ...
  @override
  AsyncValue<ServiceDetailModel> build() {
    ref.clearOnLogout();
...
class SearchNotifier extends PaginatedFamilyNotifier<ServiceModel, String> {
  final String _query;
